...
var MobileStepper = React48.forwardRef(function MobileStepper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime45.jsxs)(MobileStepperRoot, {
    square: true,
    elevation: 0,
    className: clsx_default(classes.root, className),
    ref,
    ...
    children: [backButton, variant === "text" && (0, import_jsx_runtime45.jsxs)(React48.Fragment, {
      ...
      children: [...new Array(steps)].map((_, index) => (0, import_jsx_runtime45.jsx)(MobileStepperDot, {
        className: clsx_default(classes.dot, index === activeStep && classes.dotActive),
        ownerState,
        dotActive: index === activeStep
      }, index))
    }), variant === "progress" && (0, import_jsx_runtime45.jsx)(MobileStepperProgress, {
      ownerState,
